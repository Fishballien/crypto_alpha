...
backtest_name = 'to_00125_maxmulti_25_mm_03_pf_001_240701'  # mwgt_010 #_lqdt_500_mm_06 #_mm_03_pf_001
# backtest_name = 'to_040_mwgt_040'


# %%
to_rate_thresh_L0 = 0.0125
to_rate_thresh_L1 = 1
to_rate_thresh_L2 = 1
to_rate_thresh_L3 = 1
...
factor = factor.loc['20230701':'20230801']
...
w0 = (factor.iloc[0] / np.sum(np.abs(factor.iloc[0]))).values
w_list.append(w0)
...
for idx, t in enumerate(tqdm(factor.index[1:], desc='simulating trades')):
    try:
        ...
        # breakpoint()
        import pickle
        if t == pd.Timestamp('2023-07-21 11:30:00'):
            to_save = {}
            ...
            to_save['w0'] = w0
            with open(backtest_dir / 'data_230721_1130.pkl', 'wb') as f:
