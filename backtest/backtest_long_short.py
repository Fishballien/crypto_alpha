...
# %%
twap_list = ['twd30_sp240'] #, 'twd30', 'twd60', 'twd120', 'twd240'
# test_name = 'ridge_v5_ma15_only_1'
# test_name = 'ridge_v5_lb_1y_alpha_1000'
# test_name = 'ridge_v9_1y_crct_240T'
# test_name = 'ridge_v10_15T'
# test_name = 'ridge_v13_agg_240709_2_1y'
test_name = 'esmb_objv1_agg_240715_2'
# test_name = "base_for_esmb_ridge_prcall"
# backtest_name = 'lnst_to_003_maxmulti_6'  # mwgt_010 #_lqdt_500_mm_06
backtest_name = 'lnst_to_003_mwgt_040'
...
opt_func = partial(future_optimal_weight_lp_cvxpy_long_short, max_multi=max_multi, max_wgt=max_wgt, 
                   tradv_thresh=tradv_thresh, momentum_limits=momentum_limits,
                   _lambda=_lambda)
optimize_with_level_func = partial(optimize_with_level,
                                   to_rate_thresh_l1=to_rate_thresh_L1, opt_func=opt_func)
optimize_long_short_func = partial(optimize_long_short, optimize_with_level=optimize_with_level_func)
...
for idx, t in enumerate(tqdm(factor.index, desc='simulating trades')):
    try:
        ...
        if t - last_big_move_t > timedelta(days=big_move_days):
            ...
            if idx == 0:
                w1 = optimize_long_short_func(alpha, w0, if_to_trade, tradv_t, mm_t, 1)
            else:
                w1 = optimize_long_short_func(alpha, w0, if_to_trade, tradv_t, mm_t, to_rate_thresh_L0)
